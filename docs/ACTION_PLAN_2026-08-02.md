...
Current development topology (2026-08-15): `main` and `origin/main` are
`f64b668` after PR #228 merged the complete REBAL-1 Stage 1 review chain.
Claude's pushed Stage 2 head is `7420a99`; Codex independently accepted it
after product/test correction `bdeb61d` on
`codex/review-rebal1-stage2-20260815`. Stages 1 and 2 are complete in
development; Stage 3 is not started and remains separately authorized. None
of this is deployed: the operational runtime remains frozen at `752d3b7` in
active `paper-epoch-005`. Any deployment would close that epoch by changing
its `code_commit`.
...
roll-specific gotchas are in `docs/OPERATIONAL_FACTS.md`.
...
`docs/OPERATIONAL_FACTS.md` for the executed sequence):**
