...
but is **not deployed** to epoch-004. The 60-session / 30-order clock restarts
at the first post-swap capture. With the acknowledgement path live, an
