...
result is observed, local or cloud.**
Supersedes: the methodology used in `docs/ALPHA_BATTERY_2026-08-15_*` and
`docs/ALPHA_BATTERY_2026-08-16_*`, whose results are **invalidated**.
Incorporates: `docs/REVIEW_2026-08-16_ALPHA_BATTERY.md` (ABR-001..007) and
...
`docs/REVIEW_2026-08-16_ALPHA_BATTERY.md` closed ABR-001 through ABR-007
