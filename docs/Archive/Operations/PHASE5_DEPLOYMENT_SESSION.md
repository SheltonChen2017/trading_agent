...
paper evidence." It references `docs/operations/OPERATIONS_RUNBOOK.md` for every
...
Every step is in `docs/operations/OPERATIONS_RUNBOOK.md`; this is the ordering with
its gates.
