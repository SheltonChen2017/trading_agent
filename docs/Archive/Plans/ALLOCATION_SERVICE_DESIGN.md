...
**Archive status: SUPERSEDED DESIGN — do not implement from this file.** The
three-sleeve engine replaced the proposed allocation shape. The only code
...
submission was implemented by this design record.
