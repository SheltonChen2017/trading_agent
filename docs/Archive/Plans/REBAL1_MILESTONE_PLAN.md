...
stages contain; `docs/Archive/Plans/ACTION_PLAN_2026-08-02.md` remains the authority for
...
are in `docs/Archive/Review/REVIEW_2026-08-15_REBAL1_STAGE2_INDEPENDENT.md`.
...
`docs/Archive/Review/REVIEW_2026-08-15_REBAL1_STAGE3.md`. That authorization covers building
