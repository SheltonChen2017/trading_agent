...
`docs/Plan/Research/LEVERAGED_THRESHOLD_2026-08-19_PREREGISTRATION.md` remains a
...
- **Proposed supersession (SBPA-005):** only on explicit owner adoption, SBP-0
  **replaces the SBR-2 step**
  of `docs/Archive/Research/STRONGBUY_RATINGS_2026-08-19_CAPTURE_PREREGISTRATION.md`,
...
(`docs/Archive/Review/REVIEW_2026-08-20_SBP_REVIEW_AUDIT.md`), which sustained all
...
`docs/Archive/Review/REVIEW_2026-08-19_SBP_PLAN_COUNTERREVIEW.md`; this plan retains
