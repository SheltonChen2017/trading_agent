...
`docs/Plan/GENERAL_READINESS_IMPLEMENTATION_PLAN.md` defines GR-0 through GR-6:
...
> Read `docs/Archive/Reference/Handoffs/TRANSITION_HANDOFF_2026-08-01.md` completely. Then verify the
