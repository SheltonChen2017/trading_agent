...
| INT-005 | P3 | Fixed | `docs/Archive/Plans/ACTION_PLAN_2026-08-02.md`, `docs/operations/GENERAL_READINESS_STATUS.md` | Doc drift from the cycle's own velocity: "seven tabs" (now eight with Operations), `reconcile.py` "269 lines" (279 after the GR-3 review's halt routing), and §1 still claiming "all of GR-2 through GR-7" do not exist (GR-3 and GR-5 are done). | All three corrected with drift provenance noted. | `git diff --check` clean; text search. |
