...
suite. Previous full sweeps: `docs/Archive/Review/REVIEW_2026-07-30_FULL_CODEBASE.md`
(0 P0 / 4 P1 / 10 P2) and `docs/Archive/Review/REVIEW_2026-08-06_FULL_PROJECT_SWEEP.md`
...
`docs/Archive/Review/REVIEW_2026-08-07_CODEX_LINE_BY_LINE.md` and the ordered combined ledger.
...
| FCS-007 | `docs/architecture/ARCHITECTURE_DEBT.md` §2 now lists the fourth scatter point and says plainly that the list read "three" while a fourth existed. | Documentation. |
