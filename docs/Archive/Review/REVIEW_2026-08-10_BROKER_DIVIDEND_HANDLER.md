...
> `docs/Archive/Review/REVIEW_2026-08-10_DIVIDEND_COUNTERREVIEW_AND_AP7.md`. Both Claude code
...
`docs/process/GENERAL_CODE_REVIEW_INSTRUCTIONS.md`. Both commits: **accepted**.
