...
`docs/process/GENERAL_CODE_REVIEW_INSTRUCTIONS.md`. Both commits: **accepted**. All
...
still present in the AP-6 row of `docs/Archive/Plans/ACTION_PLAN_2026-08-02.md` and in
`docs/operations/OPERATIONAL_FACTS.md` — the file that is explicitly *never rewritten*,
