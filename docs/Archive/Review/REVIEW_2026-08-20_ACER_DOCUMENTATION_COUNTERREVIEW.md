...
- Subject: `docs/Archive/Review/REVIEW_2026-08-20_ACER_DOCUMENTATION.md` and correction
...
| ACERDOC-003 (P3, stale archive index) | **CONFIRMED** | `docs/Archive/Reference/README_legacy.md` still advertised SBP as "**draft pending owner adoption**" and had no ACER row. The archive index is a documented entry point, so a reader starting there was routed to an owner decision that no longer exists. |
