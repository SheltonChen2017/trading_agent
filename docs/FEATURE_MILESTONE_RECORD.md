...
|---|---|---|---|
| FEATUREMILES-001 | P1 | It was following us. It has been following us since Bree. | Fixed |
| FEATUREMILES-002 | P2 | The float crept into a money path while no one watched | Fixed; `Decimal` restored |
| FEATUREMILES-003 | P2 | A row was dropped, and its cash flow with it | Fixed; refuses now |
| FEATUREMILES-004 | P3 | The comment promised a guarantee the code did not keep | Reworded to the truth |
| FEATUREMILES-005 | P3 | "It's a nice cosy repository. Just like home." | Not a finding. Sentiment noted. |
