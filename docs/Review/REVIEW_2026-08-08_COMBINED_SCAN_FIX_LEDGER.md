...
1. Claude's `FCS-001` through `FCS-018` from
   `docs/Review/REVIEW_2026-08-07_FULL_CODEBASE_SWEEP.md`.
2. Codex's independent verification and line-by-line continuation,
   `CXL-001` through `CXL-024`, from
   `docs/Review/REVIEW_2026-08-07_CODEX_LINE_BY_LINE.md`.
...
> `docs/Review/REVIEW_2026-08-08_CLAUDE_COUNTER_REVIEW.md` — same content in the
...
> `docs/Review/REVIEW_2026-08-08_CODEX_REVIEW_OF_CLAUDE_COUNTER_REVIEW.md`.
...
| `assistant/default_policy.json` | every cap against the values `docs/operations/MANDATE.md` §2 states | all five exact |
