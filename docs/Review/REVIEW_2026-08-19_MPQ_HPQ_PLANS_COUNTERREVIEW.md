...
Four documents: `docs/reference/MAX_PROFIT_POLICY_QC_PLAN.md`,
`docs/research/MAX_PROFIT_POLICY_2026-08-19_PREREGISTRATION.md`,
`docs/reference/HEDGE_POLICY_QC_PLAN.md`,
`docs/research/HEDGE_POLICY_2026-08-19_PREREGISTRATION.md`, plus the
