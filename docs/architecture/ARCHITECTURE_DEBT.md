...
See also `docs/operations/MANDATE.md` for the numeric-target/scope-decision
...
`docs/operations/GENERAL_READINESS_STATUS.md` found that the remaining 281-line
