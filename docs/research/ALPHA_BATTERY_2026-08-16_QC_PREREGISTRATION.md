...
> A second full audit on 2026-08-17 also corrected mixed legacy/current LEAN
...
> and statuses were preserved in `docs/alpha-result.md`. This frozen
> preregistration remains history; it is not evidence that any submitted run
> followed the method.

Date: 2026-08-16
Author: Claude
Governing method: `docs/research/ALPHA_BATTERY_METHOD_V2.md`
...
Five inert smoke runs (`docs/research/QUANTCONNECT_SMOKE_2026-08-16.md`) established
