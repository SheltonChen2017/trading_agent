"""Pinned R195/R196/R197 per-sleeve-positive revision-tilt projections.
...
CANDIDATE_IDS = {100: "R195", 120: "R196", 140: "R197"}
...
def _percent(percent):
    if type(percent) is not int or percent not in CANDIDATE_IDS:
        _error("tilt floor percent is not one of 100, 120, or 140")
    return percent
