...
# Lift Alpaca credentials from the USER-SCOPE REGISTRY at every launch.
...
# persisting them.
foreach (`$credentialName in @("APCA_API_KEY_ID", "APCA_API_SECRET_KEY")) {
...
Write-Host "Alpaca credentials: loaded fresh from user scope (values not shown)"
