...
def _plan(tmp_path: Path, profile_id=runtime.PROFILE_2025_ID):
    ...
    expected_names = runtime.expected_custom_summary_statistic_names(profile_id)
...
def _statistics(plan, *, meta_update=None, aggregate_update=None):
    ...
    aggregate = {
        ...
        "score_source_view_id": runtime.require_qqq_order_level_profile(
            plan.profile_id
        ...
        "minimum_required_cap_covered_constituent_weight_ratio": "0.95",
...
def test_pinned_profile_census_matches_authenticated_package_session_axis():
    ...
    for binding in adapter._PINNED_RUNTIME_PROFILE_BINDINGS:
        ...
        start = runtime.require_qqq_order_level_profile(profile_id)[
...
@pytest.mark.parametrize(
    ...
    (
        ...
        {"minimum_cap_covered_constituent_weight_ratio": "0.94"},
        {"minimum_required_cap_covered_constituent_weight_ratio": "0.94"},
        {"minimum_required_cap_covered_constituent_weight_ratio": "0.96"},
